...
void freq2acorr_process(freq2acorr_obj *obj, const freqs_obj *freqs, const tracks_obj *tracks, acorrs_obj *acorrs)
{
...
// sd changed to improve classification
        if (tracks->ids[iSignal] != 0 && tracks->activity[iSignal] > 0.2)
        {
